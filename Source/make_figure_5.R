...
#tiff(file = "./Output/figure5.tif", width = 5.5, height = 6.5, units = "in", compression = "lzw", res = 600)
layout(matrix(1:2, nrow=2))
CVlist <- list(HF_sunsetCV, LF_sunsetCV)
labels <- c("(HF)", "(LF)")

par(mar = c(3.5, 4.5, 0.5, 1), mgp = c(2.25, 0.75, 0), cex = 0.9, cex.axis = 1.25, cex.lab = 1.25)
