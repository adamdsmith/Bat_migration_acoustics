...
```{r check-estimate-bias, fig.width=8, fig.height=4.5}
...
With that established, we can view the relationships from the model fits (figures 3 and 4 in the manuscript).
...
```{r figure4, fig.width=10, fig.height=6.5}
# Figure 4
